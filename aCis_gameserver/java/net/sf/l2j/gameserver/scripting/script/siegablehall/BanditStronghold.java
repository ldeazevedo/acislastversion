...
/**
 * In order to participate in a battle to occupy the Bargained�s Headway clan hall, the head of a clan of level 4 or above must complete the Brigand�s Hideaway quest within a certain time before the clan hall battle is started. Only the first five clans that complete the hideaway quest first can
