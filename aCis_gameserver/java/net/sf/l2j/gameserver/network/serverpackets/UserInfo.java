...
public class UserInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		writeD(dress != null && dress.getGloves() != 0 ? dress.getGloves() : _player.getInventory().getItemObjectIdFrom(Paperdoll.GLOVES));
		...
		writeD(dress != null && dress.getFeet() != 0 ? dress.getFeet() : _player.getInventory().getItemObjectIdFrom(Paperdoll.FEET));
		...
		writeD(dress != null && dress.getGloves() != 0 ? dress.getGloves() : _player.getInventory().getItemIdFrom(Paperdoll.GLOVES));
		...
		writeD(dress != null && dress.getFeet() != 0 ? dress.getFeet() : _player.getInventory().getItemIdFrom(Paperdoll.FEET));
