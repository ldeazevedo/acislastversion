...
//	private static DressMe dressMe = null;
	...
	protected final void writeImpl()
	{
		...
		for (int i = 0; i < size; i++)
		{
			...
			writeD(isDressMe && slot.getDressMe().getGloves() != 0 ? slot.getDressMe().getGloves() : slot.getPaperdollObjectId(Paperdoll.GLOVES));
			writeD(isDressMe && slot.getDressMe().getChest() != 0 ? slot.getDressMe().getChest() : slot.getPaperdollObjectId(Paperdoll.CHEST));
			writeD(isDressMe && slot.getDressMe().getLegs() != 0 ? slot.getDressMe().getLegs() : slot.getPaperdollObjectId(Paperdoll.LEGS));
			writeD(isDressMe && slot.getDressMe().getFeet() != 0 ? slot.getDressMe().getFeet() : slot.getPaperdollObjectId(Paperdoll.FEET));
			...
			writeD(isDressMe && slot.getDressMe().getGloves() != 0 ? slot.getDressMe().getGloves() : slot.getPaperdollItemId(Paperdoll.GLOVES));
			writeD(isDressMe && slot.getDressMe().getChest() != 0 ? slot.getDressMe().getChest() : slot.getPaperdollItemId(Paperdoll.CHEST));
			writeD(isDressMe && slot.getDressMe().getLegs() != 0 ? slot.getDressMe().getLegs() : slot.getPaperdollItemId(Paperdoll.LEGS));
			writeD(isDressMe && slot.getDressMe().getFeet() != 0 ? slot.getDressMe().getFeet() : slot.getPaperdollItemId(Paperdoll.FEET));
