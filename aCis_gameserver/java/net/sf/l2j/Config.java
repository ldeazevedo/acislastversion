...
public final class Config
{
	...
	{
	//	final ExProperties tvt = initProperties(CLANS_FILE);
		try
		{
			...
			{
				String[] tvtNpcCoords = tvt.getProperty("TvTEventParticipationNpcCoordinates", "0,0,0").split(",");
				...
				else
				{
					...
					TVT_EVENT_MIN_LVL = Byte.parseByte(tvt.getProperty("TvTEventMinPlayerLevel", "1"));
					TVT_EVENT_MAX_LVL = Byte.parseByte(tvt.getProperty("TvTEventMaxPlayerLevel", "80"));
					...
					tvtNpcCoords = tvt.getProperty("TvTEventTeam1Coordinates", "0,0,0").split(",");
					if (tvtNpcCoords.length < 3)
					{
						TVT_EVENT_ENABLED = false;
					...
					else
					{
						...
						tvtNpcCoords = tvt.getProperty("TvTEventTeam2Coordinates", "0,0,0").split(",");
						if (tvtNpcCoords.length < 3)
						{
							TVT_EVENT_ENABLED = false;
						...
						else
						{
							...
							tvtNpcCoords = tvt.getProperty("TvTEventParticipationFee", "0,0").split(",");
							try
							{
							...
							tvtNpcCoords = tvt.getProperty("TvTEventReward", "57,100000").split(";");
							...
							tvtNpcCoords = tvt.getProperty("TvTDoorsToOpen", "").split(";");
							...
							tvtNpcCoords = tvt.getProperty("TvTDoorsToClose", "").split(";");
							for (String door : tvtNpcCoords)
							{
								try
								{
							...
							tvtNpcCoords = tvt.getProperty("TvTEventFighterBuffs", "").split(";");
							...
							tvtNpcCoords = tvt.getProperty("TvTEventMageBuffs", "").split(";");
							if (!tvtNpcCoords[0].isEmpty())
							{
